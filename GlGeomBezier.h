/*
* GlGeomBezier.h - Version 1.1 - November 13, 2020
*
...
//     * Call RenderPatches(i,n) to render n patches starting with the i-th patch.
...
public:
    ...
    void RenderPatches(int i, int n);   // Render patches i through i+n-1 (n patches)
